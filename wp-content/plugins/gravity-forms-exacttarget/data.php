<?php
class GFExactTargetData{

    public static function update_table(){
        global $wpdb;
        $table_name = self::get_exacttarget_table_name();
    ...
    public static function get_exacttarget_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_exacttarget";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_exacttarget_table_name());
    }
}
?>
